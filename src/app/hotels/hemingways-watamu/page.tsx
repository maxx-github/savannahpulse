...
import { 
  ...
  FaSpa, FaWater, FaCheck, FaArrowLeft, FaCalendar, FaUsers, FaBed 
} from "react-icons/fa";

const hotelData = {
  name: "Hemingways Watamu",
  location: "Watamu Coast, Kenya",
  rating: 4.8,
  reviews: 980,
  ...
  amenities: [
    ...
    { icon: FaSpa, name: "Zuri Spa" },
    { icon: FaUtensils, name: "Oceanfront Dining" },
    { icon: FaCar, name: "Airport Shuttle" },
  ...
  rooms: [
    {
      ...
      bed: "1 King Bed",
      price: 450,
      features: ["Lush garden views", "Private terrace", "Rain shower", "Mini bar"],
      cancellation: "Free cancellation until 14 days prior"
    },
    {
      id: "ocean-suite",
      ...
      bed: "1 King Bed",
      price: 650,
      features: ["Panoramic ocean views", "Outdoor bathtub", "Living area", "Butler service"],
      cancellation: "Free cancellation until 14 days prior"
    },
    {
      id: "beach-villa",
      ...
      bed: "1 King + 1 Queen",
      price: 1100,
      features: ["Direct beach access", "Private plunge pool", "Outdoor dining", "Dedicated host"],
      cancellation: "Non-refundable"
    }
  ]
};

export default function HemingwaysWatamuPage() {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-10">
            ...
            <div>
              <h2 className="font-serif text-2xl font-bold mb-6">Resort Amenities</h2>
