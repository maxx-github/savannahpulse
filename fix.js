...
// 1. Fix tsconfig.json to ensure @/* alias works
...
// 2. Check/Create AirportSearch.tsx
const airportPath = 'src/components/AirportSearch.tsx';
if (fs.existsSync(airportPath)) {
  console.log('✅ AirportSearch.tsx already exists');
} else {
  console.log('❌ AirportSearch.tsx missing. Creating it now...');
...
`;
  ...
  fs.writeFileSync(airportPath, code);
  console.log('✅ Created src/components/AirportSearch.tsx');
}

console.log('\n🎉 Fix complete! Please restart your dev server (Ctrl+C, then npm run dev)');